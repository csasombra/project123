    ...
    <div class="message-row">
      <div class="template">
        ...
        <div class="incre-row text-center">
          <label class="text-white">Hi <b>{{user.username}}!</b> Are you sure you want to complete this transaction?</label>
...
export default {
  ...
  methods: {
    transfer(){
      ...
      this.$refs.authenticateOOTP.show()
    },
    successOTP(){
      LEDGER.processRequest(AUTH.messenger.group, this.user, response => {
